...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "playbook@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "playbook API";

        private String description = "playbook API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "playbook";
